...
function Test() {
  ...
  return (
    <div className="homepage">
      ...
      >
        <button onClick={() => toggleRotation("x")} style={{ marginBottom: "10px" }}>
          Toggle Rotation X Axis
        </button>
        <button onClick={() => toggleRotation("y")} style={{ marginBottom: "10px" }}>
          Toggle Rotation Y Axis
        </button>
        <button onClick={() => toggleRotation("z")} style={{ marginBottom: "10px" }}>
          Toggle Rotation Z Axis
        </button>
      </div>
    </div>
  );
